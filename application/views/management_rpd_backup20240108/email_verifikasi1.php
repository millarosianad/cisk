...
<html lang="en">
  ...
  <body>
    ...
    <p>Dear Bapak <?= $username_verifikasi1 ?></p>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td width="50%">: <?= number_format($total_biaya); ?></td>
        </tr>
        <tr>
            <td width="20%">&nbsp;</td>
            <td width="50%">

            <a href="<?= base_url() ?>master_data/rpd_verifikasi1/<?= $signature_pengajuan ?>"><button type="button" class="button_accept">Approve / Reject</button></a>
