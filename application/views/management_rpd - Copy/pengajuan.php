...
<div class="row">
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-5">
            <input type="file" class="form-control" id="files" name="attachment_radius_perjalanan" required>
        </div>
    </div>
            ...
            <table id="example" style="overflow-x: scroll;">
                ...
                <tbody>     
                    ...
                    <tr>
                        ...
                        <!-- <td><?= $a->created_at ?></td> -->
                        <td><a href="<?= base_url().'management_rpd/realisasi/'.$a->signature ?>" class="btn btn-submit btn-sm" target="_blank">input akomodasi</a></td>
                    </tr>
                    <?php endforeach; ?>   
                </tbody>
            </table>
