                ...
                <div class="form-input-content">
                    <div class="card login-form mb-0">
                        <div class="card-body pt-5">
                            <a class="text-center" href="index.html"> <h4>Login Site</h4></a>
                            ...
                            <p class="mt-5 login-form__footer">Lupa password login ? <a href="<?php echo base_url(); ?>login_sistem/formLupaPassword" class="text-primary">Klik Reset Password</a></p>
