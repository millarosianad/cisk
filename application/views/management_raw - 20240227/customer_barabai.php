    ...
    <div class="card-block">
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="form-group">
                    <a href="<?= base_url().'management_raw/template_customer_barabai' ?>" class="btn btn-outline-warning">download template customer barabai</a>
                    <?php echo form_submit('submit', 'Import CSV Customer Barabai', 'class="btn btn-primary"'); ?>
                    <?php echo form_close(); ?>
                </div> 
                ...
                <table id="example" class="table table-striped table-bordered" style="display: inline-block; overflow-y: scroll">
                    <thead>
                        <tr>
                            ...
                            <th>Namacomp</th>
                            <th>File Mapping</th>
                            <th>Count Raw (Unique Customer ID ND6)</th>
                            <th>Created at</th>
                            <th>Created by</th>
                        </tr>
                    </thead>
