...
<html lang="en">
  ...
  <body>
    ...
    <p>Dear Bapak <?= $username_verifikasi2 ?></p>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <a href="<?= base_url() ?>master_data/rpd_verifikasi2/<?= $signature_pengajuan ?>"><button type="button" class="button_accept">Approve / Reject</button></a>
