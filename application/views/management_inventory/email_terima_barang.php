...
<html lang="en">
  ...
  <body>
    ...
    <table border="0">
        ...
        <tr>
            <td width="20%">- Terima Barang at</td>
            <td width="50%">: <?= $tanggal_terima_barang; ?></td>
        </tr>
        <tr>
            <td width="20%">- Nama Penerima</td>
            <td width="50%">: <?= $nama_penerima; ?></td>
        </tr>
        <tr>
            <td width="20%">- No Terima Barang / LPK</td>
            <td width="50%">: <?= $no_terima_barang; ?></td>
        </tr>
        <tr>
    ...
    <table border = 1>
        ...
        <?php foreach ($get_pengajuan_detail_filter->result() as $a) : ?>
        <tr>
            <td><?= $a->nama_status ?></td>
            <td><?= $a->kodeprod ?></td>
            <td><?= $a->namaprod ?></td>
