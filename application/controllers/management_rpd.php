...
{    
    ...
    public function pengajuan(){
        // if ($this->session->userdata('username') != 'Tri' && $this->session->userdata('username') != 'Sudarsono' && $this->session->userdata('username') != 'hendra') {
    ...
    public function verifikasi_pengajuan_delto($signature_pengajuan){
        ...
        if ($total_biaya >= 1000000) {
            ...
            $update_approval = [
                ...
                "verifikasi2_by"  => 521,
                "status"        => 1,
                "nama_status"   => "pending atasan 1" . ' - ' . $username_verif2,
                "jumlah_verifikasi" => 2
            ];
        }else{
            // rpsh dan pak hendy
    ...
    public function email_status_verifikasi($signature_pengajuan){ //email untuk cc Admin
        ...
        $email_cc = $this->model_management_rpd->get_user($created_by)->row()->email.',millarosianad@gmail.com';
        ...
        // $user_pelaksana = $this->model_management_rpd->get_pengajuan_bysignature($signature_pengajuan)->row()->userid_pelaksana;
        $this->db->select('supp');
        ...
        if ($supp_pelaksana == 001) {
            ...
            if ($send) {
                // echo 'verifikasi1_name : '.$verifikasi1_name;
                // echo 'verifikasi2_name : '.$verifikasi2_name; die;
    ...
    public function pengajuan_delete_soft($signature){
        ...
        if ($this->session->userdata('username') == 'ilham' || $this->session->userdata('username') == 'suffy' ) { // kalau admin bisa delete
