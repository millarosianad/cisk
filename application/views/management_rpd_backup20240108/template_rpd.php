...
<body>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><font size="12px"><?php echo number_format($row->biaya); ?></td>
            <td><font size="12px"><?php echo $row->status_claim; ?></td>
    ...
    <?php 
        ...
        <?php 
            ...
            <table class="table table-bordered mt-3">
                <tr>
                    <th width="20%"><font size="12px">Rencana Aktivitas</th>
                    <th width="10%"><font size="12px">Status Realisasi</th>
                    <th width="50%"><font size="12px">Keterangan</th>
                </tr>
                <?php foreach ($get_aktivitas->result() as $row) { ?>
                <tr>
                    <td><font size="12px"><?php echo $row->aktivitas; ?></td>
                    <td><font size="12px">
                        <?php 
                            if ($row->status_realisasi == 1) {
                                echo "Ya";
                            }else if ($row->status_realisasi === 0) {
                                echo "Tidak";
                            } else if ($row->status_realisasi == null) {
                                echo "NULL";
                            }else{
                                echo "NULL2";
                            }
