...
<html lang="en">
  <head>
    ...
    <!-- azia CSS -->
    <link rel="stylesheet" href="<?= base_url() ?>assets_milla/css/azia.css">
    ...
    <script src="<?= base_url() ?>assets_milla/sweetalert/sweetalert2.all.min.js"></script>
      ...
      <div class="container">
        ...
        <div class="az-header-menu">
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a href="" class="nav-link with-sub"><i class="typcn typcn-document"></i> Target</a>
              <nav class="az-menu-sub">
                <a href="<?= base_url() ?>target_principal/deltomed_breakdown_subbranch" class="nav-link">Deltomed By Subbranch</a>
                <a href="<?= base_url() ?>" class="nav-link">Deltomed By Kodeproduk</a>
                <a href="<?= base_url() ?>" class="nav-link">Deltomed By Divisi</a>
              </nav>
            </li>
          </ul>
        </div>
        <div class="az-header-right">
          ...
          <div class="dropdown az-profile-menu">
            <a href="" class="az-img-user"><img src="<?= base_url() ?>assets_milla/img/faces/face1.jpg" alt=""></a>
