...
{    
    ...
    public function verifikasi1_update(){
        ...
        $verifikasi2_status = $this->input->post('verifikasi2_status');

        if ($status_verifikasi == 0) {
            $verifikasi_name = 'reject';
            $status = 0;
            $nama_status = 'reject';
        }elseif ($status_verifikasi == 1 && $verifikasi2_status == 0) {
            $verifikasi_name = 'approve';
            $status = 1;
            $nama_status = 'pending atasan 2';
        }elseif ($status_verifikasi == 1 && $verifikasi2_status == 1) {
            $verifikasi_name = 'approve';
            $status = 1;
            $nama_status = 'approve';
        }
    ...
    public function verifikasi2_update(){
        $status_verifikasi = $this->input->post('status_verifikasi');
        $verifikasi1_status = $this->input->post('verifikasi1_status');

        if ($status_verifikasi == 0) {
            $verifikasi_name = 'reject';
            $status = 0;
            $nama_status = 'reject';
        }elseif ($status_verifikasi == 1 && $verifikasi1_status == 0) {
            $verifikasi_name = 'approve';
            $status = 1;
            $nama_status = 'pending atasan 1';
        }elseif ($status_verifikasi == 1 && $verifikasi1_status == 1) {
            $verifikasi_name = 'approve';
            $status = 1;
            $nama_status = 'approve';
        }
