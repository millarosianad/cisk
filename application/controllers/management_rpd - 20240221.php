...
{    
    ...
    public function pengajuan(){
        // if ($this->session->userdata('id') != '749' && $this->session->userdata('id') != '297'  && $this->session->userdata('id') != '849' && $this->session->userdata('id') != '615' && $this->session->userdata('id') != '547') {
    ...
    public function email_verifikasi_akomodasi($signature_pengajuan){
        ...
        $subject = "MPM Site | RPD : $no_rpd | INPUT AKOMODASI";
        $this->load->model('model_relokasi');
        $this->model_relokasi->email();
