                                            ...
                                            <div class="col-6">
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="form-control" type="text" value="<?= $log->no_pengajuan;?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="form-control user" type="text" value="<?= $log->branch_name;?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="form-control user" type="text" value="<?= $log->nama_comp;?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input class="form-control user" type="text" value="<?= $log->nama;?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input class="form-control user" type="text" value="<?= $log->nama_status;?>" readonly>
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <button type="button" class="btn btn-warning btn-sm" id="testOnclick" 
                                                            onclick="get_site_code('<?= $log->signature ?>')" data-toggle="modal" data-target="#vendor">switch</button>
                                                            <?php $this->load->view('retur/modal_status_retur') ?>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <textarea name="keterangan_lain" cols="10" rows="5" class="form-control" readonly><?= $log->keterangan_lain;?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
