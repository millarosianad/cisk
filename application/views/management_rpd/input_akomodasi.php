...
<div class="row mt-5 ms-5">
    ...
    <div class="row mt-2 mb-5">
        ...
        <div class="col-md-4">
            <input type="hidden" name="signature_pengajuan" value="<?= $signature_pengajuan ?>">
            <input type="submit" class="btn btn-generate" value="Save Akomodasi" <?= $this->session->userdata('username') == 'milla' || $this->session->userdata('username') == 'suffy' ? 'enabled' : 'disabled' ?>>
