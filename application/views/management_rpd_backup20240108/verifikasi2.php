...
<div class="row">
    <div class="col-md-6">
        ...
        <input type="hidden" name="userid_verifikasi2" value="<?= $userid_verifikasi2 ?>">
        ...
        <div class="col-md-12 mt-4 mb-4">     
            ...
            <div class="col-md-9">
                <input type="text" name="password_login" class="form-control" id="password_login" placeholder="masukkan password login web anda" required>
            </div>
        </div>
