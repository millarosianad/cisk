...
class Model_management_rpd extends CI_Model 
{
    public function get_pengajuan($id = ""){
        ...
        $query = "
            select 	a.no_rpd, a.pelaksana, a.maksud_perjalanan_dinas, 
                    a.tanggal_berangkat, a.tempat_berangkat, a.tanggal_tiba, a.tempat_tiba,
                    b.total_biaya, a.signature, a.nama_status, c.userid_verifikasi1, 
                    c.userid_verifikasi2, a.verifikasi1_name, a.verifikasi2_name, a.jumlah_verifikasi,
            ...
            )c on a.created_by = c.userid_pelaksana 
            where  (a.created_by = $userid or c.userid_verifikasi1 = $userid or c.userid_verifikasi2 = $userid)
            $params
            order by a.id desc
        ";
    ...
    public function get_pengajuan_bysignature($signature = ""){
        ...
        $query = "
            select 	a.id, a.no_rpd, a.pelaksana, a.maksud_perjalanan_dinas, a.tanggal_berangkat, a.tempat_berangkat, 
                    ...
                    b.userid_verifikasi1, b.userid_verifikasi2, c.username as username_verifikasi1, d.username as username_verifikasi2,
            ...
            (
                ...
                from mpm.user a 
            )c on b.userid_verifikasi1 = c.id LEFT JOIN (
                select a.id, a.username
                from mpm.user a 
            )d on b.userid_verifikasi2 = d.id
            $params
        ";
