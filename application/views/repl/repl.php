...
<div class='row'>
    ...
    <!-- <a href="<?php echo base_url()."c_repl/to_po/".$new_id_header."/001/G0101"; ?>  " class="btn btn-warning" role="button" target="_blank"> Deltomed (D1)</a> -->
    <!-- <a href="<?php echo base_url()."c_repl/to_po/".$new_id_header."/001/G0102"; ?>  " class="btn btn-warning" role="button" target="_blank"> Deltomed (D2)</a>
    <a href="<?php echo base_url()."c_repl/to_po/".$new_id_header."/001/G0103"; ?>  " class="btn btn-warning" role="button" target="_blank"> Deltomed (D3)</a> -->
