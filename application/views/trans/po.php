<!-- NOTE
- Menghilangkan Group Product
- Menambahkan Minimal Berat
 -->
        ...
        case 'manual':
        {
            ...
            if($table!='')
            {
                ...
                <?php echo $table;?>
                  ...
                  <?php $min_berat_po = $this->session->userdata('min_berat_po');
                         foreach($query2 as $a) : ?>
                    <?php if ($a->tot_berat > $min_berat_po){           
                                echo br(1);
                                ...
                                echo br(1);
                                echo "Minimal Total Berat ($min_berat_po KG)";
                            }
                        ?>
                <?php endforeach; ?>  
            <?php
