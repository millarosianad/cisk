    ...
    <div class="row mt-2">
        ...
        <div class="col-md-5">
            <div class="input-group">
                <input class="form-control" type="datetime-local" name="tanggal_mulai" required />
                <input class="form-control" type="datetime-local" name="tanggal_akhir" required />
            </div>
        </div>
    </div>
            ...
            <table id="example" style="overflow-x: scroll;">
                ...
                <tbody>     
                    ...
                    <tr>
                        ...
                        <!-- <td><?= $a->created_at ?></td> -->
                        <td><a href="<?= base_url().'management_rpd/input_akomodasi/'.$a->signature ?>" class="btn btn-submit btn-sm" target="_blank">input akomodasi</a></td>
                    </tr>
                    <?php endforeach; ?>   
                </tbody>
            </table>
